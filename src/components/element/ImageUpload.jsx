...
function ImageUpload() {
  return (
    <div>
      <svg
        className="MuiBox-root css-olkjfu w-60 h-60"
        viewBox="0 0 480 360"
      ...
      >
        <defs>
          <linearGradient
            ...
            y2="16.69%"
          >
            <stop offset="0%" stopColor="var(--theme-bg-300)"></stop>
            <stop
              offset="100%"
              stopColor="var(--theme-bg-400)"
              stopOpacity="0"
            ></stop>
          </linearGradient>
        </defs>
